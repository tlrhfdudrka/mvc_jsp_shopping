...
public class Paging {
   ...
   public void setTotalCount(int count) {
      ...
      startRow = (currentPage - 1) * pageSize + 1;  // 페이지당 시작번호 => start ★(1 - 1) * 10 + 1 = 1
      endRow = currentPage * pageSize;   // 페이지당 끝번호 => end ★1 * 10 = 10
      
      //System.out.println("startRow : " + startRow);
      //System.out.println("endRow : " + endRow);
      
      this.number = count - (currentPage - 1) * pageSize;   // 페이지번호  ★25 - (1 - 1) * 10 = 25
