...
<link rel="stylesheet" href="${path}/admin/csCenter/board/notice/css/ad_noticeList.css" />

<script src="https://kit.fontawesome.com/67a1f076db.js" crossorigin="anonymous"></script>
<script>
	$(function() {
		$("#btnInsert").click(function() {
			location.href="${path}/ad_notice_insert.nt";
		});
	});
</script>
								...
								<table>
									...
									<c:forEach var="dto" items="${list}">
										...
										<tr>
											...
											<a href="${path}/ad_notice_detailAction.nt?notice_num=${dto.notice_num}">${dto.notice_title}</a></td>
										</tr>
