...
<link rel="stylesheet" href="${path}/admin/csCenter/board/notice/css/ad_notice_detailAction.css" />
...
<script>
	$(function() {	// 상세페이지가 로딩되면
		...
		$('#btnEdit').click(function() {
			location.href="${path}/ad_notice_edit.nt?notice_num=${dto.notice_num}";
		});
