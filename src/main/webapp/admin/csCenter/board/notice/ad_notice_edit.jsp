...
<link rel="stylesheet" href="${path}/admin/csCenter/board/notice/css/ad_notice_edit.css" />
<script>
	 $(function(){ // 작성 페이지가 로딩되면
		
		// 게시글 목록버튼 클릭시 컨트롤러의 목록으로 이동
		$("#btnList").click(function() {
			location.href="${path}/ad_noticeList.nt"; // 단순 페이지 이동시에는 location
		});
						...
						<div class="table_div">
							<form name="notice_editForm" method="post">
		                       ...
		                       <table>
		                           ...
		                           <!-- <tr>
		                           <th id="passwordLabel" style="width: 60px" >비밀번호</th>
		                              <td style="width: 200px">
		                                 <input style="width: 200px" type="password" class="input" name="notice_pwd"
		                                    id="notice_pwd" size="30" placeholder="비밀번호 입력" required>
		                              </td>
		                           </tr> -->
									<tr>
