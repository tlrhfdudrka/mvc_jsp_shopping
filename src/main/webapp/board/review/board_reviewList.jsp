...
<link rel="stylesheet" href="${path}/board/review/board_reviewList.css" />
</head>
<body>
					...
					<div id="right">
						<div class="table_div">
							<form name="ad_productList" method="post">
								...
								<table>
									<tr>
									    <td class="top-border bottom-border" rowspan="4" style="width: 120;"><img src="이미지.PNG" width="100px"></td>
