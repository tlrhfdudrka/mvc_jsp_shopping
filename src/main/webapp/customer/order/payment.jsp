...
<script src="${path}/order/payment.js" defer></script>
</head>
<body>
				...
				<form name="paymentform" method="post" onsubmit="return delivery_input_chk()">
						...
						<table id="order_pd_tb" class="table">
							<tr>
								<td class="order_pd_td1">
									<img class="img/orderImg.png" src="${path}/bag/product1.png">
								</td>
						...
						<table class="table">
							<tr>
								...
								<td class="paymentInfo_td2">
									<p class="paymentInfo_p3">166,000원</p>
									<p class="paymentInfo_p3">무료</p>
									<p class="paymentInfo_p4">166,000원</p>
								</td>
							</tr>
						</table>
					</div>	
					...
					<div id="agree_payment" class="div">
						<table>
							...
							<tr>
								<td id="agree_payment_td2"><input type="submit" name="payment_btn" value="결제하기" id="payment_btn"></td>
							</tr>
						</table>
					</div>
					<!-- 결제버튼 및 동의문구 끝 -->
