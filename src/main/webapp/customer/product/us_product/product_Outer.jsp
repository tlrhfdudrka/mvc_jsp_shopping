							...
							<form name="outer" method="post">
								<ul class="outer_list">
									<c:forEach var="dto" items="${list}">
										...
										<li>
											<div class="outer_img" onclick="goToProductDetail(${dto.pd_num}, ${paging.pageNum})">
				...
				<tr>
					<td colspan="8" align="center">
						...
						<c:if test="${paging.startPage > 10}">
							<a href="${path}/product_Outer.uspd?pageNum=${paging.prev}">◀</a>
						</c:if>
						...
						<c:if test="${paging.endPage < paging.pageCount}">
							<a href="${path}/product_Outer.uspd?pageNum=${paging.next}">▶</a>
						</c:if>
					</td>
				</tr>
			</table>
